...
parser.add_argument('-O', '--image-name', default = "mobility_plot.png", help = "File name for the image file. Default: mobility_plot.png")
...
if p.ymax < 0.5 * bbox.ymax: # legend is at the bottom of the plot
    ...
    if p.xmax < 0.80 * bbox.xmax: # left side of plot
        ...
        ax.annotate(info_text, xy=(0,0), xycoords='figure fraction', xytext=xytext, ha='left', textcoords=offset, zorder=9)
    else: # right side of plot
        offset = mtext.OffsetFrom(legend, (1.0, 1.0)) # top right corner of legend
        ax.annotate(info_text, xy=(0,0), xycoords='figure fraction', xytext=xytext, ha='right', textcoords=offset, zorder=9)
...
if args.add_label:
    ax.annotate(args.add_label, xy=(0,0), xycoords='figure fraction', xytext=(-0.13,1.04), textcoords = 'axes fraction', ha='left', annotation_clip = False, fontsize = 13)
