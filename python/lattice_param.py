...
parser = argparse.ArgumentParser(
    usage="%(prog)s temperature potential",
    description="Get the lattice parameter based on T given the lattice parameter "
    "database file",
)
...
print(
    f"The lattice parameter using the {fits[args.p - 1][0]} potential "
    f"at {args.T:.1f} K is {A + B * args.T + C * args.T * args.T:.5f} Angstroms"
)
