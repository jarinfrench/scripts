...
ax1.set_zlim3d(-5,5)
#Draws the vector.
norm100 = Arrow3D([0,0],[0,-3],[0,0], mutation_scale=20, lw=4, arrowstyle="-|>", color="k")
...
ax2.set_ylim3d(-5,5)
ax2.set_zlim3d(-5,5)
norm110 = Arrow3D([0,3],[0,-3],[0,0], mutation_scale=20, lw=4, arrowstyle="-|>", color="k")
...
ax3.set_ylim3d(-5,5)
ax3.set_zlim3d(-5,5)
norm100Twist = Arrow3D([0,3],[0,0],[0,0], mutation_scale=20, lw=4, arrowstyle="-|>", color="k")
...
ax4.set_ylim3d(-5,5)
ax4.set_zlim3d(-5,5)
norm110Twist = Arrow3D([0,1.5],[0,1.5],[0,0], mutation_scale=20, lw=4, arrowstyle="-|>", color="k")
...
ax5.set_ylim3d(-5,5)
ax5.set_zlim3d(-5,5)
norm111Twist = Arrow3D([0,2],[0,2],[0,2], mutation_scale=20, lw=4, arrowstyle="-|>", color="k")
